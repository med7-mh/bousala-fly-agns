export const translations = {
  ar: {
    ...
    delete_transaction_warning:
      "هذا الإجراء لا يمكن التراجع عنه. قد يؤثر على حسابات العملاء والموردين.",
    ...
    pos_staff_desc:
      "أضف موظفين للحساب الحالي للعمل على نقاط البيع وتحديد صلاحياتهم.",
  ...
  fr: {
    ...
    delete_transaction_warning:
      "Cette action est irréversible. Elle peut affecter les comptes des clients et fournisseurs.",
    ...
    no_employees:
      "Aucun employé à afficher. Ajoutez un nouvel employé pour commencer.",
    ...
    // Settings
    settings_desc:
      "Gérer le personnel et les autorisations, voir les rapports quotidiens.",
    ...
    staff_access_tip:
      "Si vous souhaitez qu'un employé se connecte depuis son appareil, laissez-le s'inscrire et utiliser le nom de votre agence.",
    pos_staff: "Personnel Point de Vente (Compte Actuel)",
    pos_staff_desc:
      "Ajoutez du personnel pour travailler sur le point de vente et définissez leurs rôles.",
