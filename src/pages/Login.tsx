...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let errorMessage = 'حدث خطأ غير متوقع أثناء الاتصال بالخادم. حاول مجدداً.';
      ...
      if (err.message === 'TIMEOUT') {
        ...
        errorMessage = 'يبدو أن هذا الحساب قد تم إنشاؤه في وقت كان فيه النظام يواجه مشكلة في حفظ ملفات الوكالة. يرجى إنشاء حساب جديد برقم جوال آخر، أو مطالبة الدعم بحذف هذا الرقم.';
      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div>
              <label className="block text-[13px] font-semibold text-slate-600 mb-2">رقم الهاتف الجوال</label>
            ...
            <div>
              <label className="block text-[13px] font-semibold text-slate-600 mb-2">كلمة المرور</label>
