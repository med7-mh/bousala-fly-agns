      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900 mb-2">
            إدارة القسائم والاشتراكات
          </h1>
          <p className="text-slate-600">
            صفحة خاصة بصلاحيات الآدمن لإنشاء قسائم تفعيل.
          </p>
        </div>
            ...
            <table className="w-full text-right" dir="rtl">
              <thead>
                <tr className="bg-slate-50/80 border-b border-slate-100">
                  <th className="py-4 px-6 font-bold text-slate-600">
                    رمز القسيمة
                  </th>
                  ...
                  >
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-3">
                        <code className="font-mono bg-slate-100 px-3 py-1 rounded-md text-slate-800 font-bold border border-slate-200 dir-ltr">
                          {coupon.code}
                        </code>
                        <button
