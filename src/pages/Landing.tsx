    ...
    <div className="min-h-screen bg-slate-50 font-sans" dir="rtl">
          ...
          <div className="flex-1 text-center lg:text-right">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-slate-600 mb-10 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                منصة متكاملة تدير حجوزاتك، عملاءك، حسابات الموردين، وإيراداتك
                اليومية في مكان واحد. وفّر وقتك وضاعف أرباحك مع بوصلة.
              </p>
              ...
              <div className="p-6">
                ...
                <div className="space-y-3">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="h-16 bg-slate-50 border border-slate-100 rounded-lg flex items-center px-4 gap-4"
                    >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-slate-600 text-lg">
              منصة مصممة خصيصاً لتلبية احتياجات وكالات السفر والسياحة وتسهيل
              مهامها اليومية.
            </p>
          </div>
      ...
      <footer className="bg-slate-900 text-slate-400 py-8 px-6 text-center border-t border-slate-800">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-sm">
            © {new Date().getFullYear()} نظام بوصله - جميع الحقوق محفوظة
          </p>
        </div>
      </footer>
    </div>
